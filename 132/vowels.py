...
def get_word_max_vowels(text: str) -> tuple:
    ...
    vowel_counts = {w: _count_vowels(w.lower()) for w in words}
    max_key = max(vowel_counts, key=vowel_counts.get)
    return (max_key, vowel_counts[max_key])


def main():
    print('thank you for everything ...')
    print(get_word_max_vowels(paragraphs[0]))
